        ...
        <section id="convidados" className="py-20 bg-gradient-dark relative">
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    {/* Main Guest Display */}
                    <div className="relative bg-card border border-border rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 hover:border-terminal-green transition-all duration-500 hover:shadow-neon group">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                            {/* Guest Photo */}
                            <div className="relative group/photo order-2 lg:order-1">
                                <div className="aspect-square max-w-sm mx-auto lg:max-w-none rounded-2xl overflow-hidden bg-code-bg border-2 border-terminal-green/30 group-hover:border-terminal-green transition-all duration-500 group-hover:scale-105">
                                    <img
                            ...
                            <div className="space-y-4 lg:space-y-6 order-1 lg:order-2">
                                <div>
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold font-space text-foreground mb-2 group-hover:text-terminal-green transition-colors duration-500">
                                        {guests[currentGuest].name}
                                    </h3>

                                    <div className="space-y-2 lg:space-y-3 text-muted-foreground">
                                        <div className="flex items-center gap-3 group-hover:translate-x-2 transition-transform duration-500">
                                            <div className="p-2 bg-terminal-green/10 rounded-lg group-hover:bg-terminal-green group-hover:text-terminal-bg transition-all duration-500 flex-shrink-0">
                                                <Briefcase className="w-4 h-4 text-terminal-green group-hover:text-terminal-bg" />
                                            </div>
                                            <span className="text-sm sm:text-base group-hover:text-foreground transition-colors duration-500">{guests[currentGuest].role} na {guests[currentGuest].company}</span>
                                        </div>
                                        <div className="flex items-center gap-3 group-hover:translate-x-2 transition-transform duration-500 delay-100">
                                            ...
                                            <span className="text-sm sm:text-base group-hover:text-foreground transition-colors duration-500">{guests[currentGuest].location}</span>
                                        </div>
                                        <div className="flex items-center gap-3 group-hover:translate-x-2 transition-transform duration-500 delay-200">
                                            ...
                                            <span className="text-sm sm:text-base group-hover:text-foreground transition-colors duration-500">{guests[currentGuest].expertise}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="code-block group-hover:bg-terminal-green/5 transition-all duration-500 group-hover:border-terminal-green/30">
                                    <div className="text-terminal-green font-mono text-xs sm:text-sm mb-2 group-hover:text-terminal-green/80 transition-colors duration-500">
                                        <span className="text-muted-foreground">{'// '}</span>
                                        Frase marcante do episódio
                                    </div>
                                    <blockquote className="text-base sm:text-lg italic text-foreground leading-relaxed group-hover:text-terminal-green/90 transition-colors duration-500">
                        ...
                        <button
                            onClick={prevGuest}
                            className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-terminal-bg/80 backdrop-blur-sm border border-terminal-green/30 hover:border-terminal-green hover:bg-terminal-green hover:text-terminal-bg text-terminal-green rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-neon"
                        >
                        ...
                        <button
                            onClick={nextGuest}
                            className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-terminal-bg/80 backdrop-blur-sm border border-terminal-green/30 hover:border-terminal-green hover:bg-terminal-green hover:text-terminal-bg text-terminal-green rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-neon"
                        >
                    ...
                    <div className="flex justify-center gap-3">
                        {guests.map((_, index) => (
                            <button
                                ...
                                className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full transition-all duration-300 ${index === currentGuest
                                    ? 'bg-terminal-green shadow-neon scale-110'
                                    : 'bg-muted hover:bg-terminal-green/50 hover:scale-105'
                                    }`}
                            />
                        ))}
                    </div>
